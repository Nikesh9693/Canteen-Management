    ...
    previewNavbar.innerHTML = `
        <div class="container flex text-center jc-ai-center">
            ...
            <div class="site-title flex align-item-center">
                <div>
                    <a href="index.html"><h1><span class="clr-red">RVS</span> <span class="clr-green">Hangout</span></h1></a>
                </div>
                <!-- Toggle Bars -->
...
if (signUpModal){
    ...
    <div class="modal-container">
        ...
        <div class="modal-content">
            <div class="md">Welcome to <br><span class="clr-red md">RVS</span> <span class="clr-green md">Hangout</span></div>
            ...
            <!-- Upper Footer -->
                <main class="grid grid-3">
                    ...
                    <article class="about">
                        ...
                        <p>RVS College of Engineering and Technology, located in Jamshedpur, Jharkhand, was established in 2004 with the primary goal of providing high-quality education in technology to contribute to society.
                        who shared a vision of establishing centers of scientific
                        learning around the country.</p>
                        <ul class="py-1">
                            <li><i class="fab fa-facebook-f"></i><a href="https://www.facebook.com/rvscet.engineering/" target="_blank"> Facebook</a></li>
                            <li><i class="fab fa-instagram"></i><a href="https://www.instagram.com/rvscet/" target="_blank">Instagram</a></li>
                    ...
                    <article class="contact">
                        <ul>
                            ...
                            <li> <i class="fas fa-phone-alt"></i> <p>+91-9693436464</p></li>
                            <li> <i class="fas fa-envelope"></i> <p>rvscet@gmail.com</p></li>
                            <li> <i class="fas fa-map-marker-alt"></i> <p>Edalbera dimna chowk jamshedpur, Jharkhand(JSR)-831002</p></li>
                            <li> <i class="fas fa-globe-asia"></i> <p>For Professional Courses, Visit: https://www.rvscollege.ac.in/</p></li>
                        </ul>
                    </article>
                </main>
                <!-- Deep Devs Info -->
                <main class="deep-devs flex">
                    ...
                    <div class="">Designed & Developed with <i class="fas fa-heart clr-red"></i> By <a href="#">Mickeyy</a></div>
                </main>
            </section>
        `;
        })
                ...
                <main class="grid grid-3">
                    ...
                    <article class="contact">
                        <ul>
                            ...
                            <li> <i class="fas fa-phone-alt"></i> <p>+91-9693436464</p></li>
                            <li> <i class="fas fa-envelope"></i> <p>rvscet@gmail.com</p></li>
                            <li> <i class="fas fa-map-marker-alt"></i> <p> Edalbera middle in the jungle Mango jamshedpur, jharkhand (JSR)-831002</p></li>
                            <li> <i class="fas fa-globe-asia"></i> <p>For Professional Courses, Visit: www.rvscet.ac.in</p></li>
                        </ul>
                    </article>
                </main>
                <!-- Deep Devs Info -->
